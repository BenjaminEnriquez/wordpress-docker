...
function enqueue_custom_assets() {
	...
	wp_enqueue_script('custom-script', get_template_directory_uri() . '/assets/bundle.js', array('jquery'), '1.0.0', true);

	// Enqueue the compiled CSS file
	wp_enqueue_style('custom-style', get_template_directory_uri() . '/assets/styles.min.css', array(), '1.1.0', 'all');
}
